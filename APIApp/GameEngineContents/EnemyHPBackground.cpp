...
void EnemyHPBackground::Update(float _DeltaTime)
{
	...
	//일단 현제거 받자
	BattleCommendActor::BattleCommendActorPtr->StringToRender(EnemyPoketMonName_R, NewTestMon1.ForUI_GetMonsterName());
	BattleCommendActor::BattleCommendActorPtr->StringToRender(EnemyPoketMonLevel_R, NewTestMon1.ForUI_GetMonsterLevel());
