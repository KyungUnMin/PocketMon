...
void BattleSkill_EnemyAgility::EnterState()
{
	BattleSkill_EnemyBase::EnterState();

	EffectRender = GetEnemyMonster()->CreateRender("Agility.bmp", BattleRenderOrder::SkillEffect);
...
void BattleSkill_EnemyAgility::Update(float _DeltaTime)
{
	...
	switch (CurState)
	{
	case BattleSkill_EnemyAgility::SkillState::WaitAppear:
		Update_WaitAppear(_DeltaTime);
		break;
	case BattleSkill_EnemyAgility::SkillState::Appear:
		Update_Appear(_DeltaTime);
		break;
	case BattleSkill_EnemyAgility::SkillState::Disappear:
		Update_Disappear(_DeltaTime);
		break;
	case BattleSkill_EnemyAgility::SkillState::WaitDisappear:
...
void BattleSkill_EnemyAgility::ExitState()
{
...
void BattleSkill_EnemyAgility::Update_Appear(float _DeltaTime)
{
...
void BattleSkill_EnemyAgility::Update_WaitAppear(float _DeltaTime)
{
...
void BattleSkill_EnemyAgility::Update_Disappear(float _DeltaTime)
{
...
void BattleSkill_EnemyAgility::Update_WaitDisappear(float _DeltaTime)
{
