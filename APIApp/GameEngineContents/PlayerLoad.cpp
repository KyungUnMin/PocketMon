...
void Player::PlayerRenderLoad()
{
	...
	SetPos(GameEngineWindow::GetScreenSize().half());
	{
		...
		Players->CreateAnimation({ .AnimationName = "Right_Move",  .ImageName = "WalkRight.bmp", .Start = 0, .End = 3, .InterTime = 0.0625f });
		Players->CreateAnimation({ .AnimationName = "Left_Move",  .ImageName = "WalkLeft.bmp", .Start = 0, .End = 3 , .InterTime = 0.0625f });
		Players->CreateAnimation({ .AnimationName = "Up_Move",  .ImageName = "WalkUp.bmp", .Start = 0, .End = 3 , .InterTime = 0.0625f });
